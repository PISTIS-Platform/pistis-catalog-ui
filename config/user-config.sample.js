...
const glueConfig = {
  api: {
    ...
    anonymizerFrontendUrl:'https://develop.pistis-market.eu/anonymizer',
  ...
  content: {
    datasets: {
      ...
      facets: {
        ...
        defaultFacetOrder: ['catalog', 'publisher', 'format', 'categories', 'keywords', 'dataScope', 'country', 'dataServices', 'scoring', 'license'],
        scoringFacets: {
